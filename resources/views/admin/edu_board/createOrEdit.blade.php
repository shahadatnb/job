...
@section('title',"Edu Board")
@section('content')
<!-- Default box -->
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title">{{__('Edu Board')}}</h3>
        <div class="card-tools">
          <a href="{{route('eduBoard.index')}}" class="btn btn-sm btn-info"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
        </div>
    </div>
    <div class="card-body">
      @include('admin.layouts._message')
      @if (request()->routeIs('eduBoard.edit'))
        {!! Form::model($eduBoard, array('route'=>['eduBoard.update',$eduBoard],'method'=>'PUT','files' => true)) !!}
      @else
        {!! Form::open(array('route'=>['eduBoard.store'],'files' => true)) !!}
      @endif
        <div class="row">
          <div class="col-6">
