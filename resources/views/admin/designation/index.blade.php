...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
          <a class="btn btn-primary" href="{{ route('designation.create')}}">New Item</a>
        </div>
    </div>
    <div class="card-body">
                      ...
                      <div class="btn-group btn-group-sm">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <div class="dropdown-divider"></div>
                            <a href="{{route('designation.edit',$item->id)}}" class="dropdown-item"><i class="fas fa-edit"></i> Edit</a>
                            <div class="dropdown-divider"></div>
                            <form class="delete" action="{{ route('designation.destroy',$item->id) }}" method="post">
                              {{ csrf_field() }}
                              {{ method_field('DELETE') }}
